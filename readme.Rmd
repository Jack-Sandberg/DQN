...
evalplot <- ggplot() + geom_line(aes(eval_reward_D3QN$Step, eval_reward_D3QN$Value, colour = "D3QN"), size = 1) + 
...
rewardplot <- ggplot() + geom_smooth(aes(training_reward_D3QN$Step, training_reward_D3QN$Value, colour = "D3QN"), span = 0.01, se = F) + 
...
```{r all plots, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 15, fig.height = 6, dev="svg"}
library(gridExtra)
grid.arrange(evalplot, rewardplot, logplot,
             widths = c(1,1,2),
